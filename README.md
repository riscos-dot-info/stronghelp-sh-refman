StrongHelp Reference Manual
============================

This project contains the source files for the StrongHelp Reference Manual [hosted on riscos.info](http://www.riscos.info/downloads/stronghelp/manuals/).
